...
if __name__ == '__main__':
    ...
    # Load ulang model dari checkpoint terbaik
    ...
    # Save ke format HuggingFace
    save_dir = f'./saved_models/{model_name}{with_cnn_str}_version{version}/{batch_size}_{learning_rate}'
    trained_model.model.save_pretrained(save_dir)
    pretrained_tokenizer.save_pretrained(save_dir)
